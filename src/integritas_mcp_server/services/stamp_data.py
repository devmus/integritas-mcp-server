...
#             # --- URL PATH (multipart) ---
#             elif req.file_url:
#                 built = await maybe_await(form_from_file_url(session, str(req.file_url), "application/octet-stream"))
#             else:
#                 built = await maybe_await(form_from_file_path(req.file_path, "application/octet-stream"))
